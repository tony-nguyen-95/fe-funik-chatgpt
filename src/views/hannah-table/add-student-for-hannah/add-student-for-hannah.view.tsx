  ...
  return (
    ...
    >
      <div className="bg-white min-w-[40rem] min-h-[27rem] py-5 flex flex-col justify-center items-center rounded-lg relative animate-popup">
        ...
        >
          <h2 className="text-2xl font-semibold text-center text-white">Thêm Học Viên cho Hannah</h2>
          <button
            ...
            <tbody className="text-gray-600 text-sm font-light">
              {students.map((student, index) => (
                <tr
                  ...
                  className={`transition-[background-color] hover:text-gray-700 border-b border-gray-200 hover:bg-gray-100 ${
                    index % 2 === 0 && !selectedStudents.includes(student.studentId) ? 'bg-white' : 'bg-gray-100'
